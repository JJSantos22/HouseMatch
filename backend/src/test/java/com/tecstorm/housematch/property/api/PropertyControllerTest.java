...
class PropertyControllerTest {
    ...
    void returnsPropertyTraits() throws Exception {
        ...
        when(propertyTraitService.get(propertyId)).thenReturn(new PropertyTraitsResponse(
            com.tecstorm.housematch.personality.domain.PersonalityLevel.BALANCED,
            com.tecstorm.housematch.personality.domain.PersonalityLevel.AMBIVERT,
            com.tecstorm.housematch.personality.domain.PersonalityLevel.MEDIUM,
            com.tecstorm.housematch.personality.domain.PersonalityLevel.BALANCED,
            com.tecstorm.housematch.personality.domain.PersonalityLevel.MODERATE,
            com.tecstorm.housematch.personality.domain.PersonalityLevel.MEDIUM
        ));
